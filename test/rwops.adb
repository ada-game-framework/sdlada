...
procedure Rwops is
   ...
   begin
      ...
      declare
         ...
         Op : constant SDL.RWops.RWops :=
                SDL.RWops.RW_From_File ("test", SDL.RWops.Read_Binary);

         Offset : SDL.RWops.Offsets := -1;
      begin
         Text_IO.Put_Line ("Testing RW_Seek, RW_Tell and RW_Size:");

         --  Moving the file offset in steps of size 10.
         for I in 1 .. 10 loop
            Offset := SDL.RWops.RW_Seek
              (Context => Op,
               Offset  => 10,
            ...
            Offset := SDL.RWops.RW_Tell (Context => Op);
      ...
      begin
         ...
         SDL.RWops.RW_From_File ("test.bin", SDL.RWops.Read_Binary, Op);
         for I in 1 .. 4 loop
            Result32 := SDL.RWops.ReadLE32 (Op);
   ...
   begin
      ...
      declare
         W_Stream : aliased SDL.RWops.Streams.RWops_Stream :=
                      SDL.RWops.Streams.Open
                        (SDL.RWops.RW_From_File
                           ("out.bin",
      ...
      declare
         R_Stream : aliased SDL.RWops.Streams.RWops_Stream :=
                      SDL.RWops.Streams.Open
                        (SDL.RWops.RW_From_File
                           ("out.bin",
